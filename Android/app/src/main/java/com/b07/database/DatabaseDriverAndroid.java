...
public class DatabaseDriverAndroid extends SQLiteOpenHelper {
    ...
    public void reInitializeHelper() {
    ...
    protected long insertNewUserHashedPwd(String name, int age, String address, String password) {
        long id = insertUser(name, age, address);
        insertHashedPassword(password, (int) id);
        return id;
    }
    ...
    protected Cursor getUserActiveAccounts(int userId) {
        ...
        Cursor cursor = sqLiteDatabase
                .rawQuery("SELECT * FROM ACCOUNT WHERE userId = ? and ACTIVE = ?",
